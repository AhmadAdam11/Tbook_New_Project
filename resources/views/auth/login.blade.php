        ...
        <div class="flex items-center px-8 md:px-12 lg:px-32 py-8 relative">
            <div class="max-w-[380px] w-full">
                ...
                <p class="text-[12px] text-gray-500 mt-2.5 leading-relaxed">
                    Login to your digital library, manage borrowed books,
                ...
                {{-- Success --}}
                @if (session('success'))
                    <div class="mt-4 bg-green-50 text-green-700 rounded-lg p-2.5 text-xs">
                        {{ session('success') }}
                    </div>
                @endif

                {{-- FORM --}}
                <form action="/login" method="POST" class="mt-6 space-y-3.5">
                    @csrf
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <img src="{{ asset('assets/images/mail.svg') }}"
                                 class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 opacity-60">
                            <input type="email"
                                   name="email"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <img src="{{ asset('assets/images/eyes.png') }}"
                                 class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 opacity-60">
                            <input type="password"
                                   name="password"
                                   placeholder="● ● ● ●"
